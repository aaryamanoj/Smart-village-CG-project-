...
void Car(int x, bool direction) {
    int y = direction ? 35 : 55; // y position based on direction
...
void mall_model() {
    ...
    for(int i = 0; i < 3; i++) {
        for(int j = 0; j < 2; j++) {
            glBegin(GL_POLYGON);
            glVertex2i(60 + i*30, 80 + j*30);
            glVertex2i(60 + i*30, 100 + j*30);
            glVertex2i(75 + i*30, 100 + j*30);
            glVertex2i(75 + i*30, 80 + j*30);
            glEnd();
        }
    }
...
void electric_line() {
    ...
    for(int i = 0; i < 3; i++) {
        glBegin(GL_POLYGON);
        glVertex2i(200 + i*300, 70);
        glVertex2i(200 + i*300, 130);
        glVertex2i(205 + i*300, 130);
        glVertex2i(205 + i*300, 70);
        glEnd();
    }
    ...
    for(int i = 0; i < 3; i++) {
        glVertex2i(200 + i*300, 120);
    }
    glEnd();

    glBegin(GL_LINE_STRIP);
    for(int i = 0; i < 3; i++) {
        glVertex2i(200 + i*300, 110);
    }
    glEnd();
}
///Object_End
...
// Add the highway and cars
    Highway();
    Car(car1_x, true);  // Car moving right
    Car(car2_x, false); // Car moving left
...
void moveCars() {
    car1_x += 5;
    if (car1_x > 1000) car1_x = -30;
    
    car2_x -= 5;
    if (car2_x < -30) car2_x = 1000;
